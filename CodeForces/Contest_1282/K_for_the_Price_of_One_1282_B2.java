...
public class K_for_the_Price_of_One_1282_B2 {
    ...
    static void update(int s, int e, Node n, int l, int r, int d) {
        if (s != e) {
            if (n.left == null) {
                n.left = new Node();
            }
    ...
    static void fill(int s, int e, Node n) {
        if (s != e) {
            int mid = (s + e) / 2;
            n.left = new Node();
            n.right = new Node();
            fill(s, mid, n.left);
            fill(mid + 1, e, n.right);
        }
    }
