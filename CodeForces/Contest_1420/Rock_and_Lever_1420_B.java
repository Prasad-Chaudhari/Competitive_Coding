...
public class Rock_and_Lever_1420_B {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (t-- > 0) {
            ...
            long ans = 0;
            for (int i = 0; i < n; i++) {
                ans += map.getOrDefault(Integer.highestOneBit(a[i]), 0);
                map.put(Integer.highestOneBit(a[i]), map.getOrDefault(Integer.highestOneBit(a[i]), 0) + 1);
            }
