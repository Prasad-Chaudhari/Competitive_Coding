...
public class Binary_Palindromes_1251_B {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (t-- > 0) {
            ...
            for (int i = 0; i < n; i++) {
                String s = "";
                while (s.length() < ss[i].length() && one-- > 0) {
                    s += 1;
                }
                while (s.length() < ss[i].length() && zero-- > 0) {
                    s += 0;
                }
                ss[i] = s;
            }
