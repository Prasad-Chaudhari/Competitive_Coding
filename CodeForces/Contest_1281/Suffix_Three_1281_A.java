...
public class Suffix_Three_1281_A {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (t-- > 0) {
            String s = in.next();
            String ans = "";
            for (int i = Math.min(5, s.length()); i > 0; i--) {
                if (i == 5 && s.substring(s.length() - i, s.length()).equals("mnida")) {
                    ans = "KOREAN";
                }
                if (i == 4 && (s.substring(s.length() - i, s.length()).equals("masu")
                        || s.substring(s.length() - i, s.length()).equals("desu"))) {
                    ans = "JAPANESE";
                }
                if (i == 2 && (s.substring(s.length() - i).equals("po"))) {
                    ans = "FILIPINO";
                }
            }
