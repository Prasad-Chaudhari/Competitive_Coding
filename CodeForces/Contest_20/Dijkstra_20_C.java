...
public class Dijkstra_20_C {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i < adja[1].length; i++) {
            pq.add(new Data(dist[1] + weight[1][i], 1, adja[1][i]));
        }
        ...
        while (!pq.isEmpty()) {
            Data d = pq.remove();
            dist[d.c] = Math.min(dist[d.c], d.a);
            if (!b[d.c]) {
                parent[d.c] = d.b;
            }
            b[d.c] = true;
            for (int i = 0; i < adja[d.c].length; i++) {
                if (!b[adja[d.c][i]]) {
                    pq.add(new Data(dist[d.c] + weight[d.c][i], d.c, adja[d.c][i]));
                }
            }
        }
    ...
    static class Data implements Comparable<Data> {
        ...
        public Data(long a, int b, int c) {
            this.a = a;
            this.b = b;
            this.c = c;
        }
