...
/**
 * Date: 19 Sep, 2020
 * Link: https://codeforces.com/contest/1419/problem/D
 * 
...
public class Sage_Birthday_1419_D2 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 1; i < n; i += 2) {
            Integer g = tree.floorKey(Math.min(a[i - 1], (i != n - 1) ? a[i + 1] : Integer.MAX_VALUE) - 1);
            if (g == null) {
                a[i] = tree.firstKey();
            } else {
                a[i] = g;
