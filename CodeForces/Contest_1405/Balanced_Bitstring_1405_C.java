...
/**
 * Date: 06 Sep, 2020
 * Link: https://codeforces.com/contest/1405/problem/C
 * 
...
public class Balanced_Bitstring_1405_C {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (t-- > 0) {
            ...
            boolean one[] = new boolean[k], zero[] = new boolean[k];
            for (int i = 0; i < n; i++) {
                if (c[i] == '1')
                    one[i % k] = true;
                else if (c[i] == '0')
            ...
            // System.out.println(count0 + " " + count1 + " " + possible);
            if (count0 * 2 > k || count1 * 2 > k) {
                possible = false;
            }
