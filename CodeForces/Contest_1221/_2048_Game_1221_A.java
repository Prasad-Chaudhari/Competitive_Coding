...
/**
 * Date: 19 Sep, 2019
 * Link: http://codeforces.com/contest/1221/problem/A
 * 
...
public class _2048_Game_1221_A {
    ...
    public static void main(String[] args) throws IOException {
        ...
        outer: while (t-- > 0) {
            ...
            int p = 1;
            for (int i = 0; i <= 29; i++) {
                map.put(2 * p, (map.getOrDefault(p, 0) / 2) + map.getOrDefault(2 * p, 0));
                if (map.getOrDefault(2048, 0) != 0) {
