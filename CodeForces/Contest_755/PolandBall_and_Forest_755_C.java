...
/**
 * Date: 14 Nov, 2018
 * Link: http://codeforces.com/problemset/problem/755/C
 *
...
public class PolandBall_and_Forest_755_C {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 1; i <= n; i++) {
            int re = in.ni();
            if (uf.find(i) != uf.find(re)) {
                uf.union(uf.find(i), uf.find(re));
            }
        }
        System.out.println(uf.noOfComponents());
    }
