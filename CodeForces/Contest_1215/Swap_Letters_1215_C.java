...
/**
 * Date: 15 Sep, 2019
 * Link: http://codeforces.com/contest/1215/problem/C
 * 
...
public class Swap_Letters_1215_C {
    ...
    public static void main(String[] args) throws IOException {
        ...
        LinkedList<Integer> count2 = new LinkedList<>();
        for (int i = 0; i < n; i++) {
            if (s[i] == 'a' && t[i] == 'b') {
                count.add(i + 1);
            }
        ...
        if (count.size() % 2 == 1 ^ count2.size() % 2 == 1) {
            ...
            if (count2.size() % 2 == 1) {
                int c = count2.remove();
                count.add(c);
                ans.add(new Data(c, c));
            }
            int k = count.size() / 2 + count2.size() / 2 + ans.size();
            ...
            while (!count.isEmpty()) {
                System.out.println(count.remove() + " " + count.remove());
            }
            while (!count2.isEmpty()) {
                System.out.println(count2.remove() + " " + count2.remove());
            }
        }
        in.bw.flush();
    }
