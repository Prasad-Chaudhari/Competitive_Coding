...
public class Two_Platforms_1409_E {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (t-- > 0) {
            ...
            while (i < n) {
                ...
                count += map.get(xs[i]);
                if (i != 0) {
                    dp_left[i] = Math.max(dp_left[i - 1], count);
                } else {
                    dp_left[i] = count;
                }
                i++;
            ...
            while (i >= 0) {
                ...
                count += map.get(xs[i]);
                if (i != n - 1) {
                    dp_right[i] = Math.max(dp_right[i + 1], count);
                } else {
                    dp_right[i] = count;
                }
                i--;
            ...
            ans = Math.max(dp_left[n - 1], ans);
            ans = Math.max(dp_right[0], ans);
