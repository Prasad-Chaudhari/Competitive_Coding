...
public class Decrease_the_Sum_of_Digits_1409_D {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (t-- > 0) {
            ...
            while (getsum(b) > s) {
                BigInteger add = b.mod(BigInteger.TEN);
                if (add.intValue() != 0) {
                    add = BigInteger.TEN.subtract(add);
                }
                ans = ans.add((add).multiply(pow));
                b = b.subtract(b.mod(BigInteger.TEN));
    ...
    static int getsum(BigInteger b) {
        int ans = 0;
        while (b.compareTo(BigInteger.ZERO) != 0) {
            ans += b.mod(BigInteger.TEN).intValue();
            b = b.subtract(b.mod(BigInteger.TEN));
            b = b.divide(BigInteger.TEN);
        }
        return ans;
