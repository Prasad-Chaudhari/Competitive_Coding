...
/**
 * Date: 19 Feb, 2019
 * Link: https://codeforces.com/contest/1118/problem/F1
 *
...
public class Tree_Cutting_Easy_Version_1118_F1 {
        ...
        while (!st.isEmpty()) {
            ...
            for (int i : adja[root]) {
                if (!b[i]) {
                    ...
                    count_red -= red[i];
                    count_blue -= blue[i];
                    if (!(count_red != 0 && count_blue != 0) && !(red[i] != 0 && blue[i] != 0)) {
                        count++;
                    }
                    count_red += red[i];
                    count_blue += blue[i];
