...
/**
 * Date: 12 Oct, 2018
 * Link: http://codeforces.com/contest/1066/problem/E
 *
...
public class Binary_Numbers_AND_Sum_1066_E {
    ...
    public static void main(String[] args) throws IOException {
        ...
        d = (new StringBuilder(new String(d))).reverse().toString().toCharArray();
        long p = 0;
        for (int i = 0; i < m; i++) {
            if (i < n && c[i] == '1') {
                p += pow(2, i, mod);
