...
/**
 * Date: 8 Feb, 2019
 * Link: https://codeforces.com/problemset/problem/621/C
 *
...
public class Wet_Shark_and_Flowers_621_C {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i < n; i++) {
            ...
            pro /= (r[i + 1] - l[i + 1] + 1);
            double pro1 = 1000;
            pro1 *= (r[i] - l[i] + 1 - count1);
            pro1 *= count2;
            pro1 /= (r[i] - l[i] + 1);
            pro1 /= (r[i + 1] - l[i + 1] + 1);
            double pro2 = 1000;
            pro2 *= count1;
            pro2 *= (r[i + 1] - l[i + 1] + 1 - count2);
            pro2 /= (r[i] - l[i] + 1);
            pro2 /= (r[i + 1] - l[i + 1] + 1);
            ans += 2 * pro + 2 * pro1 + 2 * pro2;
        }
