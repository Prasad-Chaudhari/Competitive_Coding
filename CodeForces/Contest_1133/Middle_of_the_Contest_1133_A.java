...
public class Middle_of_the_Contest_1133_A {
    ...
    public static void main(String[] args) throws IOException {
        ...
        int m1 = Integer.parseInt(s.substring(3));
        s = in.next();
        int h2 = Integer.parseInt(s.substring(0, 2));
        int m2 = Integer.parseInt(s.substring(3));
        int t = 0;
        while (!(h1 == h2 && m1 == m2)) {
            if (m2 == 0) {
                m2 = 60;
        ...
        System.out.println((("" + h3).length() == 1 ? "0" + h3 : h3) + ":" + (("" + m3).length() == 1 ? "0" + m3 : m3));
    }
