...
public class Balanced_Team_1133_C {
    ...
    public static void main(String[] args) throws IOException {
        ...
        int max = 0;
        for (int i = 0; i < n; i++) {
            int sum = map.getOrDefault(a[i], 0) + map.getOrDefault(a[i] + 1, 0) + map.getOrDefault(a[i] + 2, 0) + map.getOrDefault(a[i] + 3, 0) + map.getOrDefault(a[i] + 4, 0) + map.getOrDefault(a[i] + 5, 0);
