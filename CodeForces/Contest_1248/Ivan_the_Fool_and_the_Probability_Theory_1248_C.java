...
/**
 * Date: 20 Oct, 2019
 * Link: https://codeforces.com/contest/1248/problem/C
 * 
...
public class Ivan_the_Fool_and_the_Probability_Theory_1248_C {
    ...
    public static void main(String[] args) throws IOException {
        ...
        int m = in.ni();
        long mod = (long) (1e9) + 7;
        long fib[] = new long[Math.max(n, m) + 1];
        fib[1] = 1;
        fib[0] = 1;
        for (int i = 2; i <= Math.max(n, m); i++) {
            fib[i] = (fib[i - 1] + fib[i - 2]) % mod;
        }
        System.out.println(((fib[n] + fib[m] - 1) * 2) % mod);
        in.bw.flush();
    }
