...
public class Trailing_Loves_1114_C {
    ...
    public static void main(String[] args) throws IOException {
        ...
        long n = in.nl();
        long b = in.nl();
        int primes[] = Primes.getPrimes(10000001);
        Map<Long, Long> map = new Hashtable<>();
        for (int i = 0; i < primes.length && b != 1; i++) {
            long count = 0;
            while (b % primes[i] == 0) {
                b /= primes[i];
                count++;
        ...
        for (long prime : map.keySet()) {
            ...
            min = Math.min(min, pow / map.get(prime));
        }
