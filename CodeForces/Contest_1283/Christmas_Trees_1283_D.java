...
public class Christmas_Trees_1283_D {
    ...
    public static void main(String[] args) throws IOException {
        ...
        int curr = 0;
        while (occupied.size() <= n + m && curr <= last) {
            if (occupied.size() + 1 <= n + m && !occupied.contains(y[curr] + 1)) {
                occupied.add(y[curr] + 1);
                ans += Math.abs(y[curr] + 1 - tree[curr]);
                y[last] = y[curr] + 1;
                tree[last] = tree[curr];
                last++;
            }
