...
/**
 * Date: 25 Aug, 2020
 * Link: https://codeforces.com/contest/1400/problem/B
 * 
...
public class RPG_Protagonist_1400_B {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (t-- > 0) {
            int p = in.ni();
            int f = in.ni();
            int count_s = in.ni(), count_w = in.ni();
            int s = in.ni();
            int w = in.ni();
            if (s > w) {
                s ^= w;
            ...
            int max = 0;
            for (int i = 0; i <= Math.min(count_s, p / s); i++) {
                int x1 = i;
                int y1 = Math.min(count_w, (p - i * s) / w);
                int x2 = Math.min(count_s - x1, f / s);
                int y2 = Math.min(count_w - y1, (f - x2 * s) / w);
