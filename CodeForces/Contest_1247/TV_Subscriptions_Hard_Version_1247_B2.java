...
/**
 * Date: 26 Oct, 2019
 * Link: https://codeforces.com/contest/1247/problem/B
 * 
...
public class TV_Subscriptions_Hard_Version_1247_B2 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (t-- > 0) {
            ...
            for (int i = d - 1; i < n; i++) {
                ...
                map.put(a[i - d + 1], map.get(a[i - d + 1]) - 1);
                if (map.get(a[i - d + 1]) == 0) {
                    map.remove(a[i - d + 1]);
                }
            }
