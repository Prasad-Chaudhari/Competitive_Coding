...
/**
 * Date: 24 Nov, 2019
 * Link: https://codeforces.com/contest/1262/problem/C
 * 
        ...
        while (t-- > 0) {
            ...
            while (k > 1) {
                if (c[index] == ')') {
                    ...
                    for (int i = 0; i < (right - index + 1) / 2; i++) {
                        if (right - i != index + i) {
                            c[index + i] ^= c[right - i];
                            c[right - i] ^= c[index + i];
                            c[index + i] ^= c[right - i];
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (c[left] == ')') {
                    ...
                    l.add(new Data(left, right));
                }
            }
            in.println(l.size());
            for (Data d : l) {
                in.println((d.a + 1) + " " + (d.b + 1));
            }
        }
        in.bw.flush();
    }
