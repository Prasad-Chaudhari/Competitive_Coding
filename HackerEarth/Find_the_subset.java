...
/**
 * Date: 16 Jun, 2018
 * Link: https://www.hackerearth.com/challenge/competitive/june-circuits-18/algorithm/construct-the-set-7a9a6be2/
 *
...
public class Find_the_subset {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Data ddd[] = new Data[n];
        for (int i = 0; i < n; i++) {
            ddd[i] = new Data(dd[i].b, dd[i].a);
        }
        (new Heapsort()).sort(ddd);
        for (int i = 0; i < n; i++) {
            System.out.print(ddd[i].b + " ");
        }
    }
