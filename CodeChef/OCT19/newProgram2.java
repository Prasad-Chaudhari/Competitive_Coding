    ...
    public static void main(String[] args) throws IOException {
        ...
        while (t-- > 0) {
            ...
            if (m % 2 == 0) {
                ...
                boolean all_degree_even = true;
                for (int i = 0; i <= n; i++) {
                    all_degree_even &= adja[i].length % 2 == 0;
                }
                if (all_degree_even) {
                    for (int i = 1; i <= n; i++) {
                        if (adja[i].length % 2 == 0 && adja[i].length != 0) {
                            for (int j : adja[i]) {
                                if (adja[j].length % 2 == 0 && adja[j].length != 0) {
                                    ans[i] = 2;
                                    ans[j] = 3;
                                    break;
                                }
