...
class newProgram8 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (t-- > 0) {
            ...
            LinkedList<Data> pos = new LinkedList<>();
            LinkedList<Data> neg = new LinkedList<>();
            for (int i = 0; i < n; i++) {
                if ((a[i] ^ x) > a[i]) {
                    pos.add(new Data(a[i] - (a[i] ^ x), -a[i], i));
                } else {
                    neg.add(new Data(a[i] - (a[i] ^ x), -a[i], i));
                }
            }
            ...
            if (k == 1) {
                ...
                if (pos.size() % 2 == 0) {
                    ...
                    if (k % 2 == 1) {
                        ...
                        if (!neg.isEmpty()) {
                            if (-pos.peek().a - neg.peekFirst().a > 0) {
                                ans += -pos.peek().a - neg.peekFirst().a;
                            }
                        }
                    }
                }
